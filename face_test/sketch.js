...
//Check Jaw Line
      ...
      if(JLUP>(JLDN*2.6))
      {
        ...
        url = "https://www.glassesusa.com/sunglasses?p=1&frame=1&tab=0&frame_size=67&shape=44,41,42,185";
      } else
      {
        p.textSize(24);
        p.text("ROUND JAW LINE: ", p.width/2,400);
        url = "https://www.glassesusa.com/sunglasses?p=1&frame=1&tab=0&shape=186,43,184&frame_size=67";
      }
      //console.log("PD: " + PD);
     // p.textSize(24);
